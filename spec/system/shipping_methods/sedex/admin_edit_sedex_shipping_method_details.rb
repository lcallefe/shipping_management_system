...
describe 'Usuáro altera status da modalidade de entrega' do
  it 'a partir da tela inicial' do
    ...
    Sedex.delete_all
    sedexes = Sedex.create!(flat_fee:90)
  
    # Act
    login_as(user)
    visit root_path 
    click_on 'Sedex' 
    click_link('Editar', href: edit_sedex_path(sedex.id))
