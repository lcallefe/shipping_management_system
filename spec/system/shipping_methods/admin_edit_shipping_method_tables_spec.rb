...
# describe 'Usuáro altera configuração para modalidade de transporte ShippingMethod' do
...
#     sm = ShippingMethod.create!(flat_fee:45)
#     pd = ShippingMethodPriceDistance.create!(min_distance:10, max_distance:30, price:40, expressa_id:sm.id)
                    
#     # Act
#     login_as(user)
#     visit root_path 
#     click_on 'ShippingMethod' 
...
#     sm = ShippingMethod.create!(flat_fee:45)
#     dt = ShippingMethodDeliveryTimeDistance.create!(min_distance: 10, max_distance: 20, delivery_time: 15, expressa_id:sm.id)
...
#     pw = ShippingMethodPriceWeight.create!(min_weight:5, max_weight:15, price:25, expressa_id:sm.id)
...
#     sm = ShippingMethod.create!(flat_fee:45)
#     dt = ShippingMethodDeliveryTimeDistance.create!(min_distance: 10, max_distance: 20, delivery_time: 15, expressa_id:sm.id)
#     ShippingMethodDeliveryTimeDistance.create!(min_distance: 21, max_distance: 30, delivery_time: 25, expressa_id:sm.id)
