...
#     first_vehicle = Vehicle.create!(brand_name:'Ford', model:'Fiesta', fabrication_year:'2001', full_capacity:100, license_plate:'ABC-1234', 
#                                   sedex_dez_id: sm.id, status:1)
#     second_vehicle = Vehicle.create!(brand_name:'Chevrolet', model:'Kaddet', fabrication_year:'2001', full_capacity:100, license_plate:'ABC-1234', 
...
#     expect(page).to have_link('Ver detalhes', href:vehicle_path(first_vehicle.id))
