  ...
  describe '#valid?' do
    context 'numericality' do    
      it 'falso quando preço está vazio' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:10, max_distance:20, 
                                                 price:nil)
        # Act
      ...
      it 'falso quando distância mínima está vazia' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:nil, max_distance:20, 
                                                 price:13)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima está vazia' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:5, max_distance:nil, 
                                                 price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é negativa' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:-1, max_distance:20, 
                                                 price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é igual a 0' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:0, max_distance:20, 
                                                 price:20)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é negativa' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:-1, 
                                                 price:33)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é igual a 0' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:0, 
                                                 price:33)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é positiva' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:0, max_distance:999, 
                                                 price:32)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é maior que 1000' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:1001, 
                                                 price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é igual a 1000' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:1000, 
                                                  price:30)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço é maior que 70' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:100, 
                                                 price:71)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima não é um número inteiro' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:'a', max_distance:10, 
                                                 price:45)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima não é um número inteiro' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:'a', 
                                                 price:39)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço não é um número inteiro' do
        # Arrange
        shipping_method = SedexDezPriceDistance.new(min_distance:1, max_distance:10, 
                                                 price:'b')
        # Act
        shipping_method.valid?
        # Assert
