  ...
  describe '#valid?' do
    context 'numericality' do    
      it 'falso quando preço está vazio' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:10, max_weight:20, 
                                               price:nil)
        # Act
      ...
      it 'falso quando peso mínimo está vazio' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:nil, max_weight:20, 
                                                price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo está vazio' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:5, max_weight:nil, 
                                               price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo é negativo' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:-1, max_weight:20, 
                                               price:15)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo é igual a 0' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:0, max_weight:20, 
                                               price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo é negativo' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:-1, 
                                               price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo é igual a 0' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:0, 
                                               price:29)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando peso máximo é positivo' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:0, max_weight:99, 
                                               price:20)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo é maior que 100' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:101, 
                                               price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando peso máximo é igual a 100' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:100, 
                                               price:45)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço é maior que 70' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:99, 
                                               price:71)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo não é um número inteiro' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:'a', max_weight:10, 
                                               price:45)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo não é um número inteiro' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:'a', 
                                               price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço não é um número inteiro' do
        # Arrange
        shipping_method = SedexDezPriceWeight.new(min_weight:1, max_weight:10, 
                                               price:'b')
        # Act
        shipping_method.valid?
        # Assert
