...
RSpec.describe ThirdDeliveryTimeDistance, type: :model do
  describe '#valid?' do
    context 'numericality' do    
      it 'falso quando prazo está vazio' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:10, max_distance:20, 
                                                        delivery_time:nil)
        # Act
      ...
      it 'falso quando distância mínima está vazia' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:nil, max_distance:20, 
                                                        delivery_time:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima está vazia' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:5, max_distance:nil, 
                                                        delivery_time:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é negativa' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:-1, max_distance:20, 
                                                         delivery_time:42)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é igual a 0' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:0, max_distance:20, 
                                                         delivery_time:44)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é negativa' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:-1, 
                                                        delivery_time:33)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é igual a 0' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:0, 
                                                        delivery_time:33)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é positiva' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:0, max_distance:49, 
                                                        delivery_time:32)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é maior que 50' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:51, 
                                                         delivery_time:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é igual a 50' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:50, 
                                                         delivery_time:30)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando prazo é maior que 48' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:100, 
                                                         delivery_time:49)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é maior que distância máxima' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:2, max_distance:1, 
                                                         delivery_time:32)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é igual a distância máxima' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:2, max_distance:2, 
                                                         delivery_time:32)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima não é um número inteiro' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:'a', max_distance:10, 
                                                         delivery_time:120)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima não é um número inteiro' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:'a', 
                                                         delivery_time:120)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando prazo não é um número inteiro' do
        # Arrange
        shipping_method = ThirdDeliveryTimeDistance.new(min_distance:1, max_distance:10, 
                                                         delivery_time:'b')
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo do intervalo atual é menor que peso máximo do anterior' do
        ...
        shipping_method = ThirdDeliveryTimeDistance.create!(min_distance:20, max_distance:30, 
                                                            delivery_time:2, expressa_id:expressa.id)
        second_shipping_method = ThirdDeliveryTimeDistance.create!(min_distance:29, max_distance:31, 
                                                               delivery_time:3, expressa_id:expressa.id)
        # Act

        # Assert
        expect(ThirdDeliveryTimeDistance.where(id:second_shipping_method.id)).not_to exist
      end
      it 'falso quando prazo do intervalo atual é menor que prazo do anterior' do
        ...
        shipping_method = ThirdDeliveryTimeDistance.create!(min_distance:20, max_distance:30, 
                                                            delivery_time:2, expressa_id: expressa.id)
        second_shipping_method = ThirdDeliveryTimeDistance.create!(min_distance:31, max_distance:40, 
                                                                   delivery_time:1, 
