...
RSpec.describe ThirdPriceWeight, type: :model do
  describe '#valid?' do
    context 'numericality' do    
      ...
      it 'falso quando peso mínimo está vazio' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:nil, max_weight:20, 
                                               price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo está vazio' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:5, max_weight:nil, 
                                               price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo é negativo' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:-1, max_weight:20, 
                                               price:15)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo é igual a 0' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:0, max_weight:20, 
                                               price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo é negativo' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:-1, 
                                               price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo é igual a 0' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:0, 
                                               price:29)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando peso máximo é positivo' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:0, max_weight:1, 
                                               price:20)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo é maior que 30' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:31, 
                                               price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando peso máximo é igual a 30' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:30, 
                                               price:30)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo é maior que peso máximo' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:2, max_weight:1, 
                                               price:29)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo é igual a peso máximo' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:2, max_weight:2, 
                                               price:29)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo não é um número inteiro' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:'a', max_weight:10, 
                                                 price:45)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo não é um número inteiro' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:'a', 
                                               price:10)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço não é um número inteiro' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:10, 
                                               price:'b')
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso mínimo do intervalo atual é menor que peso máximo do anterior' do
        ...
        shipping_method = ThirdPriceWeight.create!(min_weight:15, max_weight:17, 
                                                   price:2, expressa_id: expressa.id)
        second_shipping_method = ThirdPriceWeight.create!(min_weight:16, max_weight:29, 
                                                          price:3, 
                                                          expressa_id: expressa.id)
        # Act

        # Assert
        expect(ThirdPriceWeight.where(id:second_shipping_method.id)).not_to exist
      end
      it 'falso quando preço do intervalo atual é menor que preço do anterior' do
        # Arrange
        expressa = Expressa.create!(flat_fee: 1)
        shipping_method = ThirdPriceWeight.create!(min_weight:10, max_weight:20, 
                                                   price:2, expressa_id: expressa.id)
        second_shipping_method = ThirdPriceWeight.create!(min_weight:21, max_weight:22, 
                                                          price:1, 
                                                          expressa_id: expressa.id)
        # Act
      ...
      it 'falso quando preço do intervalo atual é igual a preço do anterior' do
        # Arrange
        expressa = Expressa.create!(flat_fee: 1)
        shipping_method = ThirdPriceWeight.create!(min_weight:20, max_weight:28, 
                                                   price:1, expressa_id:expressa.id)
        second_shipping_method = ThirdPriceWeight.create!(min_weight:20, max_weight:28, 
                                                      price:1, expressa_id: expressa.id)
        # Act
      ...
      it 'falso quando peso máximo é atualizado para valor superior ao peso mínimo do pŕoximo intervalo' do
        ...
        shipping_method = ThirdPriceWeight.create!(min_weight:10, max_weight:20, 
                                                   price:1, expressa_id:expressa.id)
        second_shipping_method = ThirdPriceWeight.create!(min_weight:21, max_weight:30, 
                                                          price:2, expressa_id:expressa.id)
        # Act
