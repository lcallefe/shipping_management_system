  ...
  describe '#válido?' do
    context 'presença' do    
      it 'falso quando preço está vazio' do
        shipping_method = ExpressaPriceWeight.new(price:nil)
      ...
      it 'falso quando peso mínimo está vazio' do
        shipping_method = ExpressaPriceWeight.new(min_weight:nil)
      ...
      it 'falso quando peso máximo está vazio' do
        shipping_method = ExpressaPriceWeight.new(max_weight:nil)
      ...
      it 'falso quando preço é igual a 0' do
        shipping_method = ExpressaPriceWeight.new(price:0)
      ...
      it 'falso quando preço é negativo' do
        shipping_method = ExpressaPriceWeight.new(price:-1)
      ...
      it 'falso quando peso mínimo é negativo' do
        shipping_method = ExpressaPriceWeight.new(min_weight:-1)
      ...
      it 'falso quando peso mínimo é igual a 0' do
        shipping_method = ExpressaPriceWeight.new(min_weight:0)
      ...
      it 'falso quando peso máximo é negativo' do
        shipping_method = ExpressaPriceWeight.new(max_weight:-1)
      ...
      it 'falso quando peso máximo é igual a 0' do
        shipping_method = ExpressaPriceWeight.new(max_weight:0)
      ...
      it 'falso quando peso máximo é maior que 30' do
        shipping_method = ExpressaPriceWeight.new(max_weight:31)
      ...
      it 'verdadeiro quando peso máximo é igual a 30' do
        shipping_method = ExpressaPriceWeight.new(max_weight:30)
      ...
      it 'falso quando preço é maior que 50' do
        shipping_method = ExpressaPriceWeight.new(price:51)
      ...
      it 'verdadeiro quando preço é igual a 50' do
        shipping_method = ExpressaPriceWeight.new(price:50)
      ...
      it 'falso quando peso mínimo é igual a peso máximo' do
        shipping_method = ExpressaPriceWeight.new(min_weight:2, max_weight:2, price:25)
      ...
      it 'falso quando peso mínimo não é um número inteiro' do
        shipping_method = ExpressaPriceWeight.new(min_weight:'a')
      ...
      it 'falso quando peso máximo não é um número inteiro' do
        shipping_method = ExpressaPriceWeight.new(max_weight:'a')
      ...
      it 'falso quando preço não é um número inteiro' do
        shipping_method = ExpressaPriceWeight.new(price:"kk")
      ...
      it 'falso quando peso mínimo do intervalo atual é menor que peso máximo do anterior' do
        ...
        second_shipping_method = ExpressaPriceWeight.create!(min_weight:16, max_weight:29, 
                                                          price:3, 
                                                          expressa_id: expressa.id)


        
        expect(ExpressaPriceWeight.where(id:second_shipping_method.id)).not_to exist
      end
      it 'falso quando preço do intervalo atual é menor que preço do anterior' do
        ...
        shipping_method = ExpressaPriceWeight.create!(min_weight:10, max_weight:20, 
                                                   price:2, expressa_id: expressa.id)
        second_shipping_method = ExpressaPriceWeight.create!(min_weight:21, max_weight:22, 
                                                          price:1, 
                                                          expressa_id: expressa.id)
      ...
      it 'falso quando preço do intervalo atual é igual a preço do anterior' do
        ...
        second_shipping_method = ExpressaPriceWeight.create!(min_weight:20, max_weight:28, 
                                                      price:1, expressa_id: expressa.id)
      ...
      it 'falso quando peso máximo é atualizado para valor superior ao peso mínimo do pŕoximo intervalo' do
        ...
        shipping_method = ExpressaPriceWeight.create!(min_weight:10, max_weight:20, 
                                                   price:1, expressa_id:expressa.id)
        second_shipping_method = ExpressaPriceWeight.create!(min_weight:21, max_weight:30, 
                                                          price:2, expressa_id:expressa.id)
