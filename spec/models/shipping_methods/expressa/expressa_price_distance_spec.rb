  ...
  describe '#valid?' do
    context 'numericality' do    
      it 'falso quando preço está vazio' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:10, max_distance:20, 
                                                 price:nil)
        # Act
      ...
      it 'falso quando distância mínima está vazia' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:nil, max_distance:20, 
                                                 price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima está vazia' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:5, max_distance:nil, 
                                                 price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é negativa' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:-1, max_distance:20, 
                                                 price:42)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é igual a 0' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:0, max_distance:20, 
                                                 price:44)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é negativa' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:-1, 
                                                 price:33)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é igual a 0' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:0, 
                                                 price:33)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é positiva' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:0, max_distance:49, 
                                                 price:32)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é maior que 50' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:51, 
                                                 price:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é igual a 50' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:50, 
                                                 price:30)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço é maior que 50' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:100, 
                                                 price:51)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima não é um número inteiro' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:'a', max_distance:10, 
                                                 price:45)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima não é um número inteiro' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:'a', 
                                                 price:40)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando preço não é um número inteiro' do
        # Arrange
        shipping_method = ExpressaPriceDistance.new(min_distance:1, max_distance:10, 
                                                 price:'b')
        # Act
        shipping_method.valid?
        # Assert
