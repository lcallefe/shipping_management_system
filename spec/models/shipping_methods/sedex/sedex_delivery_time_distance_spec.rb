  ...
  describe '#valid?' do
    context 'numericality' do    
      it 'falso quando prazo está vazio' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:10, max_distance:20, 
                                                         delivery_time:nil)
        # Act
      ...
      it 'falso quando distância mínima está vazia' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:nil, max_distance:20, 
                                                         delivery_time:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima está vazia' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:5, max_distance:nil, 
                                                         delivery_time:24)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é negativa' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:-1, max_distance:20, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima é igual a 0' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:0, max_distance:20, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é negativa' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:-1, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é igual a 0' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:0, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é positiva' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:0, max_distance:499, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima é maior que 500' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:501, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'verdadeiro quando distância máxima é igual a 500' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:500, 
                                                         delivery_time:48)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando prazo é maior que 240' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:100, 
                                                         delivery_time:241)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima não é um número inteiro' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:'a', max_distance:10, 
                                                         delivery_time:120)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância máxima não é um número inteiro' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:'a', 
                                                         delivery_time:120)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando prazo não é um número inteiro' do
        # Arrange
        shipping_method = SedexDeliveryTimeDistance.new(min_distance:1, max_distance:10, 
                                                         delivery_time:'b')
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando distância mínima do intervalo atual é menor que distância máxima do anterior' do
        ...
        sedex_shipping_method = SedexDeliveryTimeDistance.create!(min_distance:29, max_distance:31, 
                                                                    delivery_time:3, 
                                                                    sedex_id:sedex.id)
        # Act
