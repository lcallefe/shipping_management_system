  ...
  describe '#valid?' do
    context 'numericality' do    
      ...
      it 'falso quando preço é maior que 50' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:100, 
                                               price:51)
        # Act
        shipping_method.valid?
        # Assert
      ...
      it 'falso quando peso máximo do intervalo atual é maior que peso mínimo do pŕoximo' do
        # Arrange
        shipping_method = ThirdPriceWeight.new(min_weight:20, max_weight:30, 
                                               price:'b')
        second_shipping_method = ThirdPriceWeight.new(min_weight:1, max_weight:21, 
                                                        price:'b')
        # Act
