...
SedexDeliveryTimeDistance.create!(min_distance:101, max_distance:150, delivery_time:72)

SedexPriceDistance.create!(min_distance:5, max_distance:100, price:20)
SedexPriceDistance.create!(min_distance:101, max_distance:250, price:30)
...
SedexDezDeliveryTimeDistance.create!(min_distance:101, max_distance:500, delivery_time:80)

SedexDezPriceDistance.create!(min_distance:60, max_distance:100, price:20)
SedexDezPriceDistance.create!(min_distance:101, max_distance:600, price:35)

SedexDezPriceWeight.create!(min_weight:5, max_weight:40, price:1)
SedexDezPriceWeight.create!(min_weight:41, max_weight:80, price:2)
...
wo = WorkOrder.create!(street: 'Av Compensa', city: 'Manaus', state:'AM', number:'888', customer_name:'Mario', 
                       ...
                       product_weight:10, sku:'123', departure_date:Date.today, warehouse_state:'SP', 
                       warehouse_street:'Rua dos Vianas', warehouse_city:'São Bernardo do Campo',  
                       warehouse_number:'234', distance:10, status:1, shipping_expected_date:Date.today+4, total_price:50)
